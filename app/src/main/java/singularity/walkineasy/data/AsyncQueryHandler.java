...
import singularity.walkineasy.data.DBInterface.AsyncDbQueryCallback;
...
class AsyncQueryHandler {
    ...
    private class QueryAsyncTask extends
        ...
        protected QueryResult doInBackground(final QueryTask... params) {
            ...
            switch (task.mType) {
                case INSERT: {
                    result.mInsertRowId = MySQLiteOpenHelper
                ...
                case DELETE: {
                    result.mDeleteCount = MySQLiteOpenHelper
                                    .getInstance(MyApplication.getStaticContext())
                ...
                case UPDATE: {
                    result.mUpdateCount = MySQLiteOpenHelper
                                    .getInstance(MyApplication.getStaticContext())
                ...
                case QUERY: {
                    result.mCursor = MySQLiteOpenHelper
                                    .getInstance(MyApplication.getStaticContext())
