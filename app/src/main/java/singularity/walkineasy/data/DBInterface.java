...
public class DBInterface {
     ...
     */
    private static final AsyncQueryHandler ASYNC_QUERY_HANDLER = new AsyncQueryHandler();
    ...
    public static long insert(final String table, final String nullColumnHack,
        ...
        return MySQLiteOpenHelper
                        .getInstance(MyApplication.getStaticContext())
    ...
    public static interface AsyncDbQueryCallback {
         ...
         */
        public void onInsertComplete(final int taskId, final Object cookie, final long insertRowId);
         ...
         */
        public void onDeleteComplete(final int taskId, final Object cookie, final int deleteCount);
         ...
         */
        public void onUpdateComplete(final int taskId, final Object cookie, final int updateCount);
